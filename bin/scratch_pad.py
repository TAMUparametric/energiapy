...
from src.energiapy.components.operation.process import Process, VaryingProcess
...
Resource_deterministic_availability = Resource(
    name='resource_deterministic_availability',
    consume=100,
    price=5,
    varying=[VaryingResource.DETERMINISTIC_AVAILABILITY],
)
Resource_deterministic_demand = Resource(
    name='resource_deterministic_demand',
    demand=True,
    varying=[VaryingResource.DETERMINISTIC_DEMAND],
)
Resource_deterministic_price = Resource(
    name='resource_deterministic_price',
    consume=100,
    price=10,
    varying=[VaryingResource.DETERMINISTIC_PRICE],
)
Resource_deterministic_revenue = Resource(
    name='resource_deterministic_revenue',
    demand=True,
    revenue=500,
    varying=[VaryingResource.DETERMINISTIC_REVENUE],
)

Process_deterministic_capacity = Process(
    name='process_deterministic_capacity',
    conversion={Resource_certain_availability: -1, Resource_deterministic_demand: 1},
    capex=1000,
    fopex=10,
    vopex=1,
    cap_max=100,
...
Process_certain_capacity = Process(
    name='process_certain_capacity',
    conversion={
        Resource_deterministic_demand: -0.5,
        Resource_deterministic_availability: -0.5,
        Resource_deterministic_price: -0.25,
        Resource_deterministic_revenue: 1,
    },
    capex=100,
    fopex=10,
    vopex=1,
...
Process_storage = Process(
    name='process_storage',
    storage=Resource_deterministic_demand,
    capex=100,
    fopex=5,
    vopex=0.5,
    cap_max=50,
...
Place = Location(
    ...
    scales=scales,
    demand_scale_level=1,
    capacity_scale_level=1,
    price_scale_level=1,
    availability_scale_level=1,
    demand_factor={Resource_deterministic_demand: demand_factor},
    capacity_factor={Process_deterministic_capacity: capacity_factor},
    price_factor={Resource_deterministic_price: price_factor},
    availability_factor={Resource_deterministic_availability: availability_factor},
...
Occurance = Scenario(
    ...
    availability_scale_level=1,
    demand={
        Place: {Resource_deterministic_demand: 25, Resource_deterministic_revenue: 25}
    },
)
...
Process_deterministic_capacity2 = Process(
    name='process_deterministic_capacity2',
    conversion={Resource_certain_availability: -1, Resource_deterministic_demand: 1},
    capex=2000,
    fopex=20,
    vopex=5,
...
Place = Location(
    ...
    processes={
        Process_certain_capacity,
        Process_deterministic_capacity2,
        Process_deterministic_capacity,
        Process_storage,
    },
    scales=scales,
    ...
    demand_factor={Resource_deterministic_demand: demand_factor},
    capacity_factor={
        Process_deterministic_capacity: capacity_factor,
        Process_deterministic_capacity2: capacity_factor2,
    },
    price_factor={Resource_deterministic_price: price_factor},
    availability_factor={Resource_deterministic_availability: availability_factor},
    revenue_factor={Resource_deterministic_revenue: revenue_factor},
