from tests.test_fixtures import (
    single_level_scale,
    multi_two_level_scale,
    multi_three_level_scale,
    scheduling_single_level_scale,
)
from src.energiapy.components.temporal_scale import Scale, ProblemType


def test_scales_defaulting(
    single_level_scale,
    multi_two_level_scale,
    multi_three_level_scale,
    scheduling_single_level_scale,
    ...
    assert single_level_scale.problem_type == ProblemType.DESIGN_AND_SCHEDULING
    ...
    assert multi_two_level_scale.problem_type == ProblemType.DESIGN_AND_SCHEDULING
