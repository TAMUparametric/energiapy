...
def test_single_location_scenario_variability_sets(single_location_scenario_variability):
    ...
    assert (single_location_scenario_variability.set_dict['resources_certain_demand'] == [
    ...
    assert (single_location_scenario_variability.set_dict['resources_certain_price'] == [
            'resource_certain_availability', 'resource_deterministic_availability'])
    assert (
    ...
    assert (single_location_scenario_variability.set_dict['resources_varying_revenue'] == [
            'resource_deterministic_revenue'])
    assert (single_location_scenario_variability.set_dict['resources_certain_revenue'] == [
            'resource_deterministic_demand'])
    assert (
    ...
    assert (single_location_scenario_variability.set_dict['resources_certain_availability'] == [
            'resource_certain_availability', 'resource_deterministic_price'])
    assert (
    ...
    assert (single_location_scenario_variability.set_dict['processes'] == [
            'process_certain_capacity', 'process_deterministic_capacity', 'process_storage', 'process_storage_discharge'])
    ...
    assert (single_location_scenario_variability.set_dict['processes_materials'] == [
            'process_certain_capacity', 'process_deterministic_capacity', 'process_storage', 'process_storage_discharge'])
    assert (single_location_scenario_variability.set_dict['processes_storage'] == [
            'process_storage'])
    assert (
    ...
    assert (single_location_scenario_variability.set_dict['processes_singlem'] == [
            'process_certain_capacity', 'process_deterministic_capacity', 'process_storage', 'process_storage_discharge'])
    assert (single_location_scenario_variability.set_dict['processes_certain_capacity'] == [
            'process_certain_capacity', 'process_storage', 'process_storage_discharge'])
    ...
    assert (single_location_scenario_variability.set_dict['materials'] == [])
    assert (
    ...
    assert (single_location_scenario_variability.set_dict['sources'] == [])
    assert (single_location_scenario_variability.set_dict['sinks'] == [])
    assert (single_location_scenario_variability.set_dict['transports'] == [])
    assert (
