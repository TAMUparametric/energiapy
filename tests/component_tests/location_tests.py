...
# Resource_uncertain_availability = Resource(name='resource_uncertain_availability', cons_max=100, basis='Units',
...
# Process_uncertain_capacity = Process(name='process_uncertain_capacity', conversion={Resource_certain_availability: -1, Resource_uncertain_demand: 1},
...
#                                    Resource_uncertain_demand: -0.6, Resource_uncertain_availability: -0.5, Resource_uncertain_price: -0.8, Resource_uncertain_revenue: 1}, capex=100, fopex=10, vopex=1, label='process certain capacity')
...
# Scenario = Scenario(name='scenario', scales=scales, network=Location, demand_scale_level=1, network_scale_level=0, scheduling_scale_level=1,
#                     demand={Location: {Resource_uncertain_demand: 50, Resource_uncertain_revenue: 50}}, label='scenario')

# LP = formulate(scenario=Scenario, constraints={Constraints.COST, Constraints.INVENTORY,
