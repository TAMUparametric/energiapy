...
def constraint_storage_min(instance: ConcreteModel, store_min: dict, location_resource_dict: dict = None,
                           network_scale_level: int = 0) -> Constraint:
...
def constraint_nameplate_inventory(instance: ConcreteModel, location_resource_dict: dict = None, network_scale_level: int = 0,
...
def constraint_storage_max(instance: ConcreteModel, store_max: dict, location_resource_dict: dict = None,
                           network_scale_level: int = 0) -> Constraint:
    """Determines where storage facility of certain capacity is inserted at location in network
