...
def constraint_production_mode(instance: ConcreteModel, mode_dict: dict, location_process_dict: dict, scheduling_scale_level: int = 0) -> Constraint:
    ...
    Args:
        ...
        location_process_dict (dict): dictionary with processes in location
