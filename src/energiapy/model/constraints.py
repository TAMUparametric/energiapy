...
# def network_land_restriction_constraint(instance: ConcreteModel, network_scale_level: int = 0, land_restriction:int = 0) -> Constraint:
#     """Land restriction at the network level
...
#     Returns:
#         Constraint: network_land_restriction_constraint
#     """
#     scales = scale_list(instance=instance, scale_levels=network_scale_level+1)

#     def network_land_restriction_rule(instance, *scale_list):
#         return instance.Land_network[scale_list] <= land_restriction
#     instance.network_land_restriction_constraint = Constraint(scales, rule=network_land_restriction_rule, doc='land required for process')
#     #constraint_latex_render(network_land_rule)
#     return instance.network_land_restriction_constraint
...
# TODO Constraints for toxicity potential
