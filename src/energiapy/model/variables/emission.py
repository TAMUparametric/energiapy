...
#Global warming potential section
    ...
    instance.global_warming_potential_process = Var(
        instance.locations, instance.processes, instance.scales_scheduling, within=NonNegativeReals, doc='global warming potential caused by each process')
    instance.global_warming_potential_resource_consumption = Var(
        instance.locations, instance.resources_purch, instance.scales_scheduling, within=NonNegativeReals, doc='global warming potential caused by each resource at consumption')
    ...
    instance.global_warming_potential_resource_discharge = Var(
        instance.locations, instance.resources_sell, instance.scales_scheduling, within=NonNegativeReals, doc='Scope 1 emissions caused by each resource at consumption')
    instance.global_warming_potential_resource = Var(
        instance.locations, instance.resources, instance.scales_scheduling, within=NonNegativeReals, doc='global warming potential caused by each resource')
    
    instance.global_warming_potential_resource_varying = Var(
        instance.locations, instance.resources_varying_gwp, instance.scales_scheduling, within=NonNegativeReals, doc='global warming potential caused by each resource')
...
#Scope 1 emissions calculation - Marco Added
    instance.global_warming_potential_location_scope1 = Var(
        instance.locations, instance.scales_network, within=NonNegativeReals, doc='Scope 1 emissions caused at each location')
    instance.global_warming_potential_network_scope1 = Var(
        instance.scales_network, within=NonNegativeReals, doc='Scope 1 emissions caused at network scale')
    instance.global_warming_potential_process_scope1 = Var(
        instance.locations, instance.processes, instance.scales_scheduling, within=NonNegativeReals, doc='Scope 1 emissions caused by each process')
    instance.global_warming_potential_resource_consumption_scope1 = Var(
        instance.locations, instance.resources_purch_scope1, instance.scales_scheduling, within=NonNegativeReals, doc='Scope 1 emissions caused by each resource at consumption')
    instance.global_warming_potential_resource_discharge_scope1 = Var(
        instance.locations, instance.resources_sell_scope1, instance.scales_scheduling, within=NonNegativeReals, doc='Scope 1 emissions caused by each resource at consumption')
    instance.global_warming_potential_resource_scope1 = Var(
        instance.locations, instance.resources, instance.scales_scheduling, within=NonNegativeReals, doc='Scope 1 emissions caused by each resource')
    instance.global_warming_potential_material_scope1 = Var(instance.locations, instance.processes_materials,
                                                     instance.scales_scheduling, within=NonNegativeReals, doc='Scope 1 emissions caused by each material')
...
#Scope 2 emissions calculation - Marco Added
    instance.global_warming_potential_location_scope2 = Var(
        instance.locations, instance.scales_network, within=NonNegativeReals, doc='Scope 2 emissions caused at each location')
    instance.global_warming_potential_network_scope2 = Var(
        instance.scales_network, within=NonNegativeReals, doc='Scope 2 emissions caused at network scale')
    instance.global_warming_potential_process_scope2 = Var(
        instance.locations, instance.processes, instance.scales_scheduling, within=NonNegativeReals, doc='Scope 2 emissions caused by each process')
    instance.global_warming_potential_resource_consumption_scope2 = Var(
        instance.locations, instance.resources_purch_scope2, instance.scales_scheduling, within=NonNegativeReals, doc='Scope 2 emissions caused by each resource at consumption')
    instance.global_warming_potential_resource_discharge_scope2 = Var(
        instance.locations, instance.resources_sell_scope2, instance.scales_scheduling, within=NonNegativeReals, doc='Scope 2 emissions caused by each resource at consumption')
    instance.global_warming_potential_resource_scope2 = Var(
        instance.locations, instance.resources, instance.scales_scheduling, within=NonNegativeReals, doc='Scope 2 emissions caused by each resource')
    instance.global_warming_potential_material_scope2 = Var(instance.locations, instance.processes_materials,
                                                     instance.scales_scheduling, within=NonNegativeReals, doc='Scope 2 emissions caused by each material')
