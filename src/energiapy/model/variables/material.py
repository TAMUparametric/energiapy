...
def generate_material_vars(instance: ConcreteModel, scale_level: int = 0):
    ...
    if hasattr(instance, 'materials') is True:
        ...
        instance.material_mode_process = Var(instance.locations, instance.processes, instance.material_modes, instance.materials, instance.scales_material_network, within= NonNegativeReals, doc = 'materials utilized in material mode for each process')
        ...
        instance.X_M = Var(instance.locations, instance.process_material_modes, instance.scales_material_network, within = Binary, doc = 'binaries process material combinations')
        instance.Cap_P_M = Var(instance.locations, instance.process_material_modes, instance.scales_material_network, within = NonNegativeReals, doc = 'capacity for process material combinations')
    return
