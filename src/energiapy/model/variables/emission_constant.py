...
def generate_emission_constant_vars(instance: ConcreteModel):
    ...
    instance.global_warming_emissions_constant_total = Var(within=NonNegativeReals, doc = 'Total Global warming emissions for the horizon')