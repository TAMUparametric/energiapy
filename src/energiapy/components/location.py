...
class Location:
    ...
    backlog_penalty_factor: Union[float, Dict[Resource, float]] = None
    ...
    def __post_init__(self):
        ...
        self.storage_capex_dict = {
            i.resource_storage.name: i.storage_capex for i in self.processes_full if i.resource_storage is not None}
