...
class transport:
    ...
    """
    def __init__(self, name:str, resources:set, intro_scale:int = 0, label:str = '', trans_max: float = 0,\
        trans_loss: float = 0, trans_cost: float = 0, trans_emit: float = 0, source:str = 'citation needed'):
