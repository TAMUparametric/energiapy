...
CAES_c = process(name='CAES_c', conversion={Air_C: 1, Power: -1}, year=2, prod_max=bigM, trl='pilot',
                         block='power_storage', label='Compressed air energy storage (CAES)', source='Zakeri 2015')
CAES_d = process(name='CAES_d', conversion={Air_C: -1.4286, Power: 1}, year=2, prod_max=bigM, trl='discharge',
                         block='power_storage', label='Compressed air energy storage (CAES) discharge', source='Zakeri 2015')
PSH_c = process(name='PSH_c', conversion={H2O_E: 1, Power: -1}, year=0, prod_max=bigM, trl='nrel',
...
SMR = process(name='SMR', year=smr_start, conversion={Power: -1.11*10**(-3), CH4: -3.76, H2O: -23.7, H2_B: 1, CO2_Vent: 9.4979}, prod_max=bigM, gwp=0, trl='enterprise',
                      block='material_production', label='Steam methane reforming', source='Mosca 2020')
ASMR = process(name='ASMR', conversion={Uranium: -4.17*10**(-5), H2O: -3364.1, Power: 1}, year=asmr_start, gwp=9100, prod_max=bigM, land=1100/1800,
...
# SMRM = process(name='SMRM', year=20, prod_max=bigM, gwp=0,
#                        trl='enterprise', block='material_production', label='Methanol SMR')
MEFC = process(name='MEFC', conversion={Power: -4.84*10**(-1), H2_G: -0.4048, CO2_DAC: -1.2143, CH3OH: 1}, year=6, prod_max=bigM, carbon_credit=True, trl='pilot',
                       block='material_production', label='Catalytic methanol production', source='Keith et al (2018), Fasihi et al (2019)')  # 10,000t/y
DAC = process(name='DAC', conversion={Power: -1.93*10**(-4), H2O: -4.048, CO2_DAC: 1}, year=4, prod_max=bigM, gwp=0,
                      trl='pilot', block='CCUS', label='Direct air capture', source='D. Belloti et al (2017)')
# DOWC = process(name='DOWC', year=20, prod_max=bigM, gwp=0,
#                        trl='repurposed', block='CCUS', label='Depleted oil wells')
EOR = process(name='EOR', year=0, conversion={Power: -0.00255, CO2: -1, CO2_EOR: 1, CO2_Vent: 0.67}, prod_max=bigM, carbon_credit=True,
...
# AQoff_DAC = process(name='AQoff_DAC', year=20, prod_max=bigM, carbon_credit=True,
# trl='repurposed', block='CCUS', label='Offshore aquifer CO2 sequestration (DAC)')
# Grid = process(name='Grid', year=20, prod_max=bigM, gwp=0.343,
