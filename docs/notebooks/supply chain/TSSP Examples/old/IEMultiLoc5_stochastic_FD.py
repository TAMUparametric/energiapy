...
if __name__ == '__main__':
    ...
    scenario_dictionary = {
        ...
        #
        'cap4_1': {'prob': 1, 'factor': pandas.DataFrame(data={('loc4', 'com1_process'): create_list(1)})},
    ...
    #
    # with open('IE_MultiLoc5_stochastic.pkl', "wb") as f:
    #     pickle.dump(UI_output_dict, f)
    #     f.close()
    #
    # results_dict = pickle.load(open('IE_MultiLoc5_stochastic.pkl', "rb"))
    #
