...
def create_event_dict(n_total: int):
    ...
    event_dict = {
        ...
        'trans47_1': {'prob': 0.05,
                      'factor': pandas.DataFrame(data={('trans47', 'com1_loc4_out'): create_list(n_total, 1)})},
        'trans47_4': {'prob': 0.95, 'factor': pandas.DataFrame(data={('trans47', 'com1_loc4_out'): default_list})},
    }
