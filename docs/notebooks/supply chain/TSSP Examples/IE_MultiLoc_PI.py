...
def create_event_dict(n_total: int):
    ...
    event_dict = {
        ...
        'cap2_52': {'prob': 0.95, 'factor': pandas.DataFrame(data={('loc2', 'com1_process'): default_list})},
        ...
        'cap4_52': {'prob': 0.99, 'factor': pandas.DataFrame(data={('loc4', 'com1_process'): default_list})},
        ...
        'cap7_52': {'prob': 0.95, 'factor': pandas.DataFrame(data={('loc7', 'com1_process'): default_list})},
        ...
        # 'res1_52': {'prob': 0.98, 'factor': pandas.DataFrame(data={('loc1', 'com1_pur'): default_list})},
        #
        ...
        # 'res6_52': {'prob': 0.98, 'factor': pandas.DataFrame(data={('loc6', 'com1_pur'): default_list})},
    }
...
def build_model(scen_df=pandas.DataFrame()):
    ...
    loc5 = Location(name='loc5',
                    processes={com1_receive_loc2, com1_receive_loc4, com1_receive_loc7, com1_process, com1_store,
                               com1_loc5_send, com1_sell}, label="Location 5", scales=scales, demand_scale_level=2,
                    capacity_scale_level=1, availability_scale_level=1)
    ...
    truck12 = Transport(name='truck12', resources={com1_loc1_out}, trans_max=truck_cap12,
                        label='Truck from location 1 to 2', capex=0.5, vopex=0.05, trans_min=0.01)
    ...
    truck13 = Transport(name='truck13', resources={com1_loc1_out}, trans_max=truck_cap13,
                        label='Truck from location 1 to 3', capex=0.3, vopex=0.03, trans_min=0.01)
    ...
    truck24 = Transport(name='truck24', resources={com1_loc2_out}, trans_max=truck_cap24,
                        label='Truck from location 2 to 4', capex=0.5, vopex=0.05, trans_min=0.01)
    ...
    truck25 = Transport(name='truck25', resources={com1_loc2_out}, trans_max=truck_cap25,
                        label='Truck from location 2 to 5', capex=0.3, vopex=0.03, trans_min=0.01)
    ...
    truck34 = Transport(name='truck34', resources={com1_loc3_out}, trans_max=truck_cap34,
                        label='Truck from location 3 to 4', capex=0.2, vopex=0.02, trans_min=0.01)
    ...
    truck45 = Transport(name='truck45', resources={com1_loc4_out}, trans_max=truck_cap45,
                        label='Truck from location 4 to 5', capex=1, vopex=0.1, trans_min=0.01)
    ...
    truck47 = Transport(name='truck47', resources={com1_loc4_out}, trans_max=truck_cap47,
                        label='Truck from location 4 to 7', capex=0.4, vopex=0.04, trans_min=0.01)
    ...
    truck64 = Transport(name='truck64', resources={com1_loc6_out}, trans_max=truck_cap64,
                        label='Truck from location 6 to 4', capex=0.5, vopex=0.05, trans_min=0.01)
    ...
    truck75 = Transport(name='truck75', resources={com1_loc7_out}, trans_max=truck_cap75,
                        label='Truck from location 7 to 5', capex=0.4, vopex=0.04, trans_min=0.01)
...
if __name__ == '__main__':
    ...
    #
    # with open('ssoln_IE_MultiLoc_PI.pkl', 'wb') as file:
