...
if __name__ == '__main__':
    ...
    ef_UI = ExtensiveForm(options, load_scenario_names, scenario_creator,
    ...
    with open(f"ssoln_{len(load_scenario_names)}_UI_HP.pkl", "wb") as file:
    ...
    with open(f"FD_{len(load_scenario_names)}_final_results_HP.pkl", 'wb') as file:
