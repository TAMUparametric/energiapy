...
sys.path.append('/scratch/user/shivam.vedant/Scripts/TSSP/AIChE2024')
# sys.path.append('../../../../src')
...
if __name__ == '__main__':
    ...
    # with open(r'/scratch/user/shivam.vedant/Scripts/TSSP/AIChE2024/sorted_result_4096_HP.pkl', 'rb') as file:
    ...
    print(*selected_scenario_names, sep='\n')
    ...
    with open(f"exCost_{len(selected_scenario_names)}_UI_HP.pkl",
              'wb') as file:
    ...
    with open(f"FD_{len(selected_scenario_names)}_final_results_HP.pkl", 'wb') as file:
