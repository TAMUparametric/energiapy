...
LiI_c = process('LiI_c', 80, True, True, True, 1000, 0, False, {'near': 0, 'mid':0, 'far':0}, 112000, 'power_storage', 'Lithium-ion battery')
LiI_d = process('LiI_d', 80, True, True, True, 1000, 0, False, {'near': 0, 'mid':0, 'far':0}, 0, 'power_storage', 'Lithium-ion battery discharge')
CAES_c = process('CAES_c', 80, False, True, True, 1000, 0, False, {'near': 0, 'mid':0, 'far':0}, 0, 'power_storage', 'Compressed air energy storage (CAES)')
CAES_d = process('CAES_d', 80, False, True, True, 1000, 0, False, {'near': 0, 'mid':0, 'far':0}, 0, 'power_storage', 'Compressed air energy storage (CAES) discharge')
PSH_c = process('PSH_c', 80, True, True, True, 1000, 0, False, {'near': 0, 'mid':0, 'far':0}, 0, 'power_storage', 'Pumped storage hydropower (PSH)')
PSH_d = process('PSH_d', 80, True, True, True, 1000, 0, False, {'near': 0, 'mid':0, 'far':0}, 0, 'power_storage', 'Pumped storage hydropower (PSH) discharge')


# PV = process('PV', True, True, True, 2.5*10**3, 'power_generation')
# WF = process('WF', True, True, True, 2.5*10**3, 'power_generation')
PV = process('PV', 10**9, True, True, True, 150, 0.25, False, {'near': 0, 'mid':0, 'far':0}, 53, 'power_generation', 'Solar photovoltaics (PV) array')
WF = process('WF', 10**9, True, True, True, 150, 0.25, False, {'near': 0, 'mid':0, 'far':0}, 10.4, 'power_generation', 'Wind mill array')
AKE = process('AKE', 10**9, True, True, True, 150, 5, False, {'near': 0, 'mid':0, 'far':0}, 0.61*19.474,'material_production', 'Alkaline water electrolysis (AWE)') #20.833 MW required to produce 1000t/day.H2
SMRH = process('SMRH', 10**9, True, True, True, 3*10**4, 10**3, False, {'near': 0, 'mid':0, 'far':0}, 0, 'material_production', 'Steam methane reforming + CCUS')
SMR = process('SMR', 10**9, True, True, True, 3*10**4, 10**3, False, {'near': 0, 'mid':0, 'far':0}, 0, 'material_production', 'Steam methane reforming')
ASMR = process('ASMR', 10**9, True, True, True, 3*10**4, 10**3, False, {'near': 0, 'mid':0, 'far':0}, 9.1, 'power_generation', 'Small modular reactors (SMRs)')

# AKE = process('AKE', True, True, True, 10**5, 'material_production')
# SMRH = process('SMRH', True, True, True, 10**5, 'material_production')
H2_C_c = process('H2_C_c', 10**9, True, True, True, 10**5, 0, False, {'near': 0, 'mid':0, 'far':0}, 0, 'material_storage', 'Hydrogen local storage (Compressed)')
H2_C_d = process('H2_C_d', 10**9, True, True, True, 10**5, 0, False, {'near': 0, 'mid':0, 'far':0}, 0, 'material_storage', 'Hydrogen local storage (Compressed) discharge')
H2_L_c = process('H2_L_c', 10**9, True, True, True, 10**5, 0, False, {'near': 0, 'mid':0, 'far':0}, 0, 'material_storage', 'Hydrogen geological sequestration')
H2_L_d = process('H2_L_d', 10**9, True, True, True, 10**5, 0, False, {'near': 0, 'mid':0, 'far':0}, 0,'material_storage', 'Hydrogen geological sequestration discharge')
SMRM = process('SMRM', 10**9, True, True, True, 10**5, 100, False, {'near': 0, 'mid':0, 'far':0}, 0, 'material_production', 'Methanol SMR')
MEFC = process('MEFC', 0.20*2058, False, True, True, 10000, 100,  True, {'near': 0.03177, 'mid': 0.05, 'far':0.05}, 0, 'material_production', 'Catalytic methanol production') #10,000t/y
DAC = process('DAC', 0.20*4*10**5, False, True, True, 10**5, 100,  True, {'near': 0, 'mid':0, 'far':0}, 0, 'CCUS', 'Direct air capture')
DOWC = process('DOWC', 0.20*10**5, False, True, True, 10**5, 100, False, {'near': 0, 'mid':0, 'far':0},  0, 'CCUS', 'Depleted oil wells')
EOR = process('EOR', 10**9, True, True, False, 10**5, 1000, True, {'near': 0.02022, 'mid': 0.035, 'far':0.035}, 0, 'CCUS', 'CO2-Enhanced oil recovery')
AQoff_SMR = process('AQoff_SMR', 0.40*10**5,  False, True, True, 10**5, 1000, True, {'near': 0.03177, 'mid': 0.05, 'far':0.05}, 0, 'CCUS', 'Offshore aquifer CO2 sequestration (SMR)')
AQoff_DAC = process('AQoff_DAC', 0.40*10**5, False, True, True, 10**5, 1000, True, {'near': 0.03177, 'mid': 0.05, 'far':0.05}, 0,'CCUS', 'Offshore aquifer CO2 sequestration (DAC)')
Grid = process('Grid', 10**12, True, True, True, 10**10, 100, False, {'near': 0, 'mid':0, 'far':0}, 0, 'power_generation', 'Grid electricity')
H2_Sink1 = process('H2_Sink1', 10**15, True, True, True, 10**8, 0,  False, {'near': 0, 'mid':0, 'far':0}, 0, 'dummy', 'Blue Hydrogen production')
H2_Sink2 = process('H2_Sink2', 10**15, True, True, True, 10**8, 0, False, {'near': 0, 'mid':0, 'far':0}, 0, 'dummy', 'Green Hydrogen production')


Charge = resource('Charge', True, True, True, False, False, 400, 1, 0, 8.9286*10**(-5), 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Battery energy storage (MW)' )
Air_C = resource('Air_C', False, True, True, False, False, 400, 50, 0, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'CAES energy storage (MW)')
H2O_E = resource('H2O_E', True, True, True, False, False, 400, 50, 0, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'PSH energy storage (MW)')
Solar = resource('Solar', True, True, True, False, False, 0, 0, 10**20, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Solar Power (MW)')
Wind = resource('Wind', True, True, True, False, False, 0, 0, 10**20, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Wind Power (MW)')

Uranium = resource('Uranium', True, True, True, False, False, 0, 0,  10**20, 0, 0, {'near': 0, 'mid':0, 'far':0}, ur_price/(250/2), 0, 0, 'Uranium (kg)')
Lithium = resource('Lithium', True, True, True, False, False, 0, 0,  10**20, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Lithium (kg)')
...
H2_C = resource('H2_C', True, True, True, True, False, 10**10, 0, 0, 0.025/24, 2, {'near': 0, 'mid':0, 'far':0}, 0, 1/(0.1180535*1.60934), 0.482803, 'Hydrogen - Local storage (kg)')
H2_L = resource('H2_L', True, True, True, True, False, 10**10, 0, 0, 0, 2, {'near': 0, 'mid':0, 'far':0}, 0, 1/(0.1180535*1.60934), 0.482803, 'Hydrogen - Geological storage (kg)')
H2 = resource('H2', True, True, True, False, False, 0, 0, 0, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Hydrogen')
H2_B = resource('H2_B', True, True, True, False, False, 0, 0,  0, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Blue hydrogen (kg)' )
H2_G = resource('H2_G', True, True, True, False, False, 0, 0, 0, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Green hydrogen (kg)')
H2O = resource('H2O', True, True, True, False, False, 0, 0, 10**20, 0, 0, {'near': 0, 'mid':0, 'far':0}, water_price/(5000*3.7854), 0, 0, 'Water (kg)')
O2 = resource('O2', True, True, True, True, False, 0, 0,  0, 0.07, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Oxygen (kg)')
CH4 = resource('CH4', True, True, True, False, False, 0, 0,  10**20, 0, 0, {'near': 0, 'mid':0, 'far':0}, ng_price/(28.32*0.68), 0, 0, 'Methane (kg)')
#CH4 price from compressed NG: $/(1000ft3) = $/(1000 ft3 * 0.0283168 m3/ft3 * 128.2 kg/m3) = $/kg 
CO2 = resource('CO2', True, True, True, False, False, 0, 0, 0, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Carbon dioxide (kg)')
CO2_DAC = resource('CO2_DAC', False, True, True, False, False, 0, 0, 0, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Carbon dioxide - captured (kg)')
# CO2_DOW = resource('CO2_DOW', False, True, True, False, True, 10**7, 0, 0, {'near': 0.03177, 'mid':0.05, 'far':0}, 0, 0, 0)
CO2_AQoff = resource('CO2_AQoff', False, True, True, False, True, 10**10, 100, 0,  0, 0, {'near': 0.03177, 'mid':0.05, 'far':0}, 0, 0, 0, 'Carbon dioxide - sequestered (kg)')
CO2_EOR = resource('CO2_EOR', True, True, False, False, True, 10**10, 0, 0, 0, 0, {'near': 0.02022, 'mid':0.035, 'far':0}, 0, 0, 0, 'Carbon dioxide - EOR (kg)')
CH3OH = resource('CH3OH', True, True, True, True, False, 0, 0, 0, 0, 0.5, {'near': 0.03177*1.2143, 'mid':0.05*1.2143, 'far':0}, 0, 1/(0.0195508*1.60934), 0.0917, 'Methanol (kg)')
Power_Gr = resource('Power_Gr', True, True, True, False, False, 0, 0, 10**20, 0, 0, {'near': 0, 'mid':0, 'far':0}, power_price*(10**(-2))*10**3, 0, 0, 'Grid electricity (MW)')
CO2_Vent = resource('CO2_Vent', True, True, True, True, False, 0, 0,  0, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Carbon dioxide - Vented (kg)')
#WO SMRM and DOWC
...
FILES = ['F_CONV', 'COST']
for file_ in FILES: 
    with open(file_ + '.pkl', 'rb') as f_: locals()[file_] = pkl.load(f_)
...
def hccus(m_: ConcreteModel(), scenario_:str, year_:int , opt_:str, solver_:str):
    ...
    print('\n==========================================================================================================')
    print('Optimizing ' + opt_.replace('_', ' ') + ' in a(n) ' + scenario_.lower()  + ' cost scenario for the year ' +  str(2022 + year_))
    ...
    I_mp = [i.name for i in II if i.block in ['material_production', 'power_generation']]
    ...
    if year_ > YEAR[0]:
        for a in A:
            I_int = np.intersect1d(np.array([*BINARY[scenario_][year_-1]['P'][a]]), I_)
            print(I_int)
            J_int = np.intersect1d(np.array([*BINARY[scenario_][year_-1]['S'][a]]), J_)
            J_int = np.intersect1d(J_int, J_store)
            m.I_int = Set(initialize = I_int, doc = 'intersection of processes between current and past year')
            m.J_int = Set(initialize = J_int, doc = 'intersection of resources between current and past year')
    
    m.I = Set(initialize = I_, doc = 'active processes')
    m.I_mp = Set(initialize = I_mp, doc = 'processes for material production')
    m.I_Q45 = Set(initialize = I_Q45, doc = 'Processes (i) that get 45Q carbon credits when produced')
    m.I_power = Set(initialize = I_power, doc = 'Dummy processes for power storage')
    m.I_nopower = Set(initialize = I_nopower, doc = 'Not dummy processes for power storage') 
    ...
    m.J_Q45 = Set(initialize = J_Q45, doc = 'resource that get 45Q carbon credits when produced')
    ...
    m.J_mile = Set(initialize = J_mile, doc = 'resources that can be used as transportation fuels')
    ...
    #=============================
    #=========================Non-negative========================
    m.Opex_fix = Var(m.A, m.I, m.Y, within = NonNegativeReals, doc = 'fixed operational expenditure of each process (i)')
    m.Opex_var = Var(m.A, m.I, m.Y, within = NonNegativeReals,doc = 'variable operational expenditure of each process (i)')
    m.Capex = Var(m.A, m.I, m.Y, within = NonNegativeReals,doc = 'capital expenditure on process (i)') 
    m.P_annual  = Var(m.A, m.I, m.Y, within = NonNegativeReals,doc = 'Annual production for each resource in each location')
    m.Cap_P = Var(m.A, m.I, m.Y, within = NonNegativeReals, doc = 'production (MW or kg/h) capacity of process (i) at location (a)') 
    m.Opex = Var(m.A, m.I, m.Y, within = NonNegativeReals, doc = 'operational expenditure of each process (i)')
    m.GWP = Var(m.A, m.I, m.Y, within = NonNegativeReals, doc = 'GWP (kg.CO2) of facility (i) for rated capacity')
    m.GWP_total = Var(m.A, m.Y, within = NonNegativeReals, doc = 'Total GWP (kg.CO2) of the system')
    
    m.B_total = Var(m.A, m.J, m.Y, within = NonNegativeReals, doc =  'Total expenditure in purchasing resource (j) in location (a)') 
    m.S_annual  = Var(m.A, m.J, m.Y, within = NonNegativeReals, doc = 'Annual sales of each resource in each location')  
    m.C_annual =  Var(m.A, m.J, m.Y, within = NonNegativeReals, doc = 'Annual consumption of each resource in each location') 
    m.GHG_total = Var(m.A, m.J, m.Y, within = NonNegativeReals, doc = 'Annual GHG emissions due to mobility')
    m.Mile_total = Var(m.A, m.Y, within = NonNegativeReals, doc = 'Annual mileage') 
    m.Credit = Var(m.A, m.I, m.Y, within = NonNegativeReals, doc = 'carbon credit from process (i)')
    m.Cap_S = Var(m.A, m.J_store, m.Y, within = NonNegativeReals, doc = 'storage capacity (MW or kg) for resource (j) at location (a)')

    m.Opex_fix_total = Var(m.A, m.Y, within = NonNegativeReals, doc = 'annualized fixed operational expenditure ($)')
    m.Opex_var_total = Var(m.A, m.Y, within = NonNegativeReals, doc = 'annualized variable operational expenditure ($)')
    m.Opex_total = Var(m.A, m.Y, within = NonNegativeReals, doc = 'annualized total operational expenditure ($)')
    m.Capex_total = Var(m.A, m.Y, within = NonNegativeReals, doc = 'total annual capital expenditure at location (a)')
    m.Credit_total = Var(m.A, m.Y, within = NonNegativeReals, doc = 'annualized total carbon credit')
    ...
    m.P = Var(m.A, m.I,  m.H, m.D, m.Y, within = NonNegativeReals, doc = 'amount ($) of resource produced by process (i) at location (a) in time period(t) of season (h)')
  
    m.B = Var(m.A, m.J, m.H, m.D, m.Y, within = NonNegativeReals, doc = 'amount ($) spent on purchase of resource (j)') 
    m.C = Var(m.A, m.J, m.H, m.D, m.Y, within = NonNegativeReals, doc= 'amount ($)  of  resource  (j)  consumed  at  location  (a)  in  time  period  (t)  of  season  (h)') 
    #m.P_M = Var(m.A, m.I, m.U, m.H, m.D, m.Y, within = NonNegativeReals)
    m.S = Var(m.A, m.J, m.H, m.D, m.Y, within = NonNegativeReals, doc = 'amount ($) of resource (j) discharged at location (a) in time period (t) of season (h)') 
    m.Inv = Var(m.A, m.J, m.H, m.D, m.Y, within = NonNegativeReals, doc = 'inventory level of resource (j) at location (a) in time period (t) of season (h)')

    #=========================Binary=========================
    m.X_P = Var(m.A, m.I, m.Y, within = Binary, doc = 'equals 1 if process (i) is built at location (a) in planning period')
    m.X_S = Var(m.A, m.J_store, m.Y, within = Binary, doc = 'equals 1 if storage facility for resource (j) is built at location (a) in planning period') 
    ...
    m.Prod_Cap_cons = Constraint(m.A, m.I, m.Y, rule = Prod_Cap_rule, doc = 'Constrains production capacity to max or 0')


    # ======================= RESOURCE BALANCE ==================================
    #NAMEPLATE PRODUCTION CAPACITY UPPERBOUND
    def Nameplate_Prod_UB_rule(m, a, i, h, d, y):
        return m.P[a, i, h, d, y] <= m.Cap_P[a, i, y]*dict_f_conv[a][i][d][h]
    m.Nameplate_Prod_UB_cons = Constraint(m.A, m.I, m.H, m.D, m.Y, rule = Nameplate_Prod_UB_rule, doc = 'Constrains production within capacity')


    #NAMEPLATE STORAGE CAPACITY UPPERBOUND
    def Nameplate_Store_UB_rule(m, a, j, h, d, y):
        return m.Inv[a, j, h, d, y] <= m.Cap_S[a, j, y]
    m.Nameplate_Store_UB_cons = Constraint(m.A, m.J_store, m.H, m.D, m.Y, rule = Nameplate_Store_UB_rule, doc = 'Constrains storage within capacity')

    def Nameplate_Store_UB_rule2(m, a, j, h, d, y):
        return m.Inv[a, j, h, d, y] == 0
    m.Nameplate_Store_UB_cons2 = Constraint(m.A, m.J_nostore, m.H, m.D, m.Y, rule = Nameplate_Store_UB_rule2, doc = 'Constrains storage within capacity2')


    #RESOURCE AVAILABILITY 
    def Resource_Avail_rule(m, a, j, h, d, y): 
        return m.C[a, j, h, d, y] <=  next((j_.consumption_max for j_ in J if j_.name == j)) 
    m.Resource_Avail_cons = Constraint(m.A, m.J, m.H, m.D, m.Y, rule = Resource_Avail_rule, doc = 'Constrains resource consumption')
    ...
    def Inventory_Balance_rule(m, a, j, h, d, y):
        ...
        # if (h == 0) and (d == 1):
            ...
            return m.Inv[a, j, h, d, y] == (1 -next((j_.loss for j_ in J if j_.name == j)))*m.Inv[a, j, h-1, d, y] \
                + sum (dict_conversion[i][j]*m.P[a, i, h, d, y] for i in m.I)\
                    + m.C[a, j, h, d, y] - m.S[a, j, h, d, y] 
    m.Inventory_Balance_cons = Constraint(m.A, m.J, m.H, m.D, m.Y, rule = Inventory_Balance_rule, doc = 'Balances and cycles inventory between consecutive periods')


    #NO SELL RULE
    def No_Sell_rule(m, a, j, h, d, y):
        return m.S[a, j, h, d, y] == 0
    m.No_Sell_cons = Constraint(m.A, m.J_nosell, m.H, m.D, m.Y, rule = No_Sell_rule, doc = 'Restricts the sale of items that cannot be sold')

    #ANNUAL SALES
    def Annual_Sales_rule(m, a, j, y):
        return m.S_annual[a, j, y] == sum(sum(m.S[a, j, h, d, y] for h in m.H) for d in m.D) 
    m.Annual_Sales_cons = Constraint(m.A, m.J, m.Y, rule = Annual_Sales_rule, doc = 'Calculates the annual sale of each resource')

    #ANNUAL PURCHASE
    def Annual_Purch_rule(m, a, j, y):
        return m.C_annual[a, j, y] == sum(sum(m.C[a, j, h, d, y] for h in m.H) for d in m.D) 
    m.Annual_Purch_cons = Constraint(m.A, m.J, m.Y, rule = Annual_Purch_rule, doc = 'Calculates the annual purchase of each resource')

    #ANNUAL PRODUCTION
    def Annual_Prod_rule(m, a, i, y):
        return m.P_annual[a, i, y] == sum(sum(m.P[a, i, h, d, y] for h in m.H) for d in m.D) 
    m.Annual_Prod_cons = Constraint(m.A, m.I, m.Y, rule = Annual_Prod_rule, doc = 'Calculates the annual production of each resource')
    ...
    m.Opex_cons = Constraint(m.A, m.I, m.Y, rule = Opex_rule, doc = 'Calculates operational expenditure for each process (i)')

    
    #TOTAL VARIABLE ANNUAL OPEX
    def Opex_var_total_rule(m, a, y):
        return m.Opex_var_total[a, y] == sum(m.Opex_var[a, i, y] for i in m.I) 
    m.Opex_var_total_cons = Constraint(m.A, m.Y, rule = Opex_var_total_rule, doc = 'Calculates operational expenditure')
  
    
    #TOTAL VARIABLE ANNUAL OPEX
    def Opex_fix_total_rule(m, a, y):
        return m.Opex_fix_total[a, y] == sum(m.Opex_fix[a, i, y] for i in m.I) 
    m.Opex_fix_total_cons = Constraint(m.A, m.Y, rule = Opex_fix_total_rule, doc = 'Calculates operational expenditure')
  
    
    #TOTAL VARIABLE ANNUAL OPEX
    def Opex_total_rule(m, a, y):
        return m.Opex_total[a, y] == m.Opex_var_total[a, y] + m.Opex_fix_total[a, y] 
    m.Opex_total_cons = Constraint(m.A, m.Y, rule = Opex_total_rule, doc = 'Calculates operational expenditure')
    ...
    m.B_total_cons = Constraint(m.A, m.J, m.Y, rule = B_total_rule, doc = 'Calculates expenditure on purchase of raw material') 
    
    #ANNUAL TAX CREDIT
    def Credit_rule(m, a, i, y): 
        return m.Credit[a, i, y] == next((i_.tax_cred[period_] for i_ in I if i_.name == i))*m.P_annual[a, i, y] 
    m.Credit_cons = Constraint(m.A, m.I_Q45, m.Y, rule = Credit_rule, doc = 'Calculates tax credit recieved through 45Q for each process (i)')

    # #TOTAL ANNUAL TAX CREDIT
    def Credit_Total_rule(m, a, y): 
        return m.Credit_total[a, y] == sum(m.Credit[a, i, y] for i in m.I_Q45)
    m.Credit_Total_cons = Constraint(m.A, m.Y, rule = Credit_Total_rule, doc = 'Calculates tax credit recieved through 45Q')
    
    #GWP POTENTIAL OF FACILITIES     
    def GWP_rule(m, a, i, y):
        return m.GWP[a, i, y] == next((i_.gwp for i_ in I if i_.name == i))*m.Cap_P[a,i,y]
    m.GWP_cons = Constraint(m.A, m.I, m.Y, rule = GWP_rule, doc = 'calculates the GWP of each facility')
    
    #TOTAL GWP OF SYSTESM 
    def GWP_total_rule(m, a, y):
        return m.GWP_total[a, y] == sum(m.GWP[a,i,y] for i in m.I)
    m.GWP_total_cons = Constraint(m.A, m.Y, rule = GWP_total_rule, doc = 'calculates the GWP of system')
    ...
    if opt_ == 'tx_miles':
        ...
        m.Mile_total_cons = Constraint(m.A, m.J_mile, m.Y, rule = Mile_total_rule, doc = 'Ensures that miles demand is met') 
        # + m.Revenue_total[a, y] 
        print('Meeting a mileage demand of ' + str(demand_) + ' miles in the year ' + str(2022 + year_))
        ...
        m.Mile_total_cons2 = Constraint(m.A, m.Y, rule = Mile_total_rule2, doc = 'Calculates total mileage from fuels production') 
    ...
    if solver_ == 'gurobi':
        ...
        if (results.solver.status == SolverStatus.ok) and\
            ...
            if case_ in ['wind_ev', 'solar_ev', 'nuclear_ev', 'grid_ev']:
                cost = m.Obj() + 2600*22*10**6#https://www.bcg.com/publications/2019/costs-revving-up-the-grid-for-electric-vehicles
            else:
                cost = m.Obj()
            # cost_per_mile = cost/miles
            
            if 'CO2_Vent' in J_:
                co2 = m.S_annual['HO', 'CO2_Vent', year_].value + m.GWP_total['HO', year_].value
            else:
            ...
            if ('CH4' in J_) and ('Power_Gr' in J_):
                ng = m.C_annual['HO', 'CH4', year_].value + m.C_annual['HO', 'Power_Gr', year_].value*7.43*0.0283168*0.68
            elif ('CH4' in J_) and ('Power_Gr' not in J_):
                ng = m.C_annual['HO', 'CH4', year_].value
            elif ('CH4' not in J_) and ('Power_Gr' in J_):
                ng = m.C_annual['HO', 'Power_Gr', year_].value*7.43*0.0283168*0.68
            else:
                ng = 0
...
for case_ in case_studies:
    ...
    if case_ in ['wind_ev', 'solar_ev', 'nuclear_ev', 'grid_ev']:
        Power = resource('Power', True, True, True, True, False, 0, 0, 0, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, (10**3)/(0.2167432**1.60934), 0, 'Renewable power generated (MW)')

    else:
        Power = resource('Power', True, True, True, False, False, 0, 0, 0, 0, 0, {'near': 0, 'mid':0, 'far':0}, 0, 0, 0, 'Renewable power generated (MW)')
    ...
    for scenario_ in SCENARIO:
        for year_ in YEAR:
            dict_results[case_]['cost'], dict_results[case_]['co2'], dict_results[case_]['cap'], dict_results[case_]['prod'],\
                dict_results[case_]['water'],  dict_results[case_]['ng'], dict_results[case_]['ur'], dict_results[case_]['land'], = hccus(m, scenario_, year_, tx_miles.name,'gurobi')
...
for case_ in case_studies:
    ...
    ax.scatter(X_, Y_, label = labels_[case_]['name'], marker = labels_[case_]['marker'],\
        color = labels_[case_]['color'], alpha = 1, lw = 2)
...
# plt.xlim(0, 3*10**11)
# plt.ylim(0, 10**7)
plt.legend(loc='lower right', ncol=4, fancybox=True, shadow=True)
lgnd = plt.legend(loc="lower right", scatterpoints=1, ncol=4, fancybox=True, shadow=True)
for i in range(16):
...
for case_ in case_studies:
    ...
    if case_ in ['wind_blue', 'wind_green', 'wind_blueish', 'wind_ev']:
        ...
        Y_ = [dict_results[case_]['land'], dict_results[case_]['water'], dict_results[case_]['cap'] - current_cap['wind']]

    if case_ in['grid_blue', 'grid_green', 'grid_blueish', 'grid_ev']:
        X_ = ['Land used', 'Capacity added', 'Natural gas cons.']
        Y_ = [dict_results[case_]['land'], dict_results[case_]['cap'] - current_cap['ng_plant'], dict_results[case_]['ng']]
    
    if case_ in['solar_blue', 'solar_green', 'solar_blueish', 'solar_ev']:
        X_ = ['Land used', 'Water cons.', 'Capacity added']
        Y_ = [dict_results[case_]['land'], dict_results[case_]['water'], dict_results[case_]['cap'] - current_cap['solar']]
    
    if case_ in['nuclear_blue', 'nuclear_green', 'nuclear_blueish', 'nuclear_ev']:
        X_ = ['Land used', 'Water cons.', 'Capacity added', 'Uranium cons.']
        Y_ = [dict_results[case_]['land'], dict_results[case_]['water'], dict_results[case_]['cap'] - current_cap['nuclear'], dict_results[case_]['ur']]
...
fig = go.Figure(data=[go.Sankey(
    ...
    value =  [-1*m.P_annual['HO', 'SMRH', year_].value*dict_conversion['SMRH']['H2O'],
        ...
        m.P_annual['HO', 'SMRH', year_].value*dict_conversion['SMRH']['CO2_Vent'] + m.P_annual['HO', 'SMRH', year_].value*dict_conversion['SMRH']['CO2'] ,\
        m.P_annual['HO', 'SMRH', year_].value*dict_conversion['SMRH']['CO2_Vent'] ,
        m.P_annual['HO', 'EOR', year_].value*dict_conversion['EOR']['CO2_EOR'],
        m.P_annual['HO', 'EOR', year_].value*dict_conversion['EOR']['CO2_EOR']*136]
    # value = [10]*9
))])
# fig.update_layout(title_text='Material flow for ' + str(2022+ year_) + ' under a ' + scenario_.lower() + ' cost scenario', font_size=14)
...
plt.annotate('Area of Houston', (0, 0.4256), verticalalignment = 'top', horizontalalignment = 'center'\
                    , fontsize = 13, color = 'slateblue')
...
plt.annotate('10$\%$ Lake Conroe\'s capacity', (0, 0.0530), verticalalignment = 'top', horizontalalignment = 'left'\
...
y_max = max(Y_)
circle1 = plt.Circle((0, 0), dict_results['grid_ev'][metric_]/y_max, color='indianred', alpha = 0.7)
circle2 = plt.Circle((0, 0), dict_results['wind_ev'][metric_]/y_max, color='powderblue', alpha = 0.7)
circle3 = plt.Circle((0, 0), dict_results['solar_ev'][metric_]/y_max, color='seagreen', alpha = 0.7)
circle4 = plt.Circle((0, 0), dict_results['nuclear_ev'][metric_]/y_max, color='slategrey', alpha = 0.7)
...
for i in np.arange(9):
    ax.annotate("{:#.2g}".format(perc_[i]) + '%', (X_[i],Y_[i]+ 5 ), verticalalignment = 'top', horizontalalignment = 'center')
plt.xticks(fontsize= 16)
plt.yticks(fontsize= 16)
plt.grid(axis = 'y', alpha = 0.5)
plt.title('Contributions to the ERCOT Grid (TWh) in 2021',fontsize = 16)
# plt.ylim(0,260)
plt.show()


# %%
print(dict_results['grid_blueish']['ng'])
# %%
