...
HO = Location(name='HO', processes={LiI_c, LiI_d, CAES_c, CAES_d, PSH_c, PSH_d, PV, WF, AKE, SMRH, H2_L_c, H2_L_d, DAC, EOR, AQoff_SMR, SMR}, demand= ho_demand_dict, scales=scales, label='Houston')
