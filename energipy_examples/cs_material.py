...
Geothermal_energy= Resource(name='Geotehrmal', store_max=10**10, sell=True, basis='MW',  label='Geothermal Storage', bock='resourcestorage')
...
CuH = Material(name='Cu', gwp=6, H20=40, basis= 'kg', label='Copper Hyro', citation= 'T.E. Norgate (2007), Sustainable water use in minerals and metal production')
...
WF = Process(name='WF', conversion={Wind: -1, Power: 1, H2O: -1}, cost = cost_dict['HO']['moderate']['WF']['0'], \
    varying= True, prod_max=bigM, gwp=0.003, land=10800/1800, trl='nrel', block='power_generation', lifetime=(20,25)\
        label='Wind mill array', citation='Use windtoolkit conversion', 'Ziegler 2018', gwp'Marco Raugei 2020')
...
ASMR = Process(name='ASMR', conversion={Uranium: -4.17*10**(-5), H2O: -3364.1, Power: 1}, cost = cost_dict['HO']['moderate']['ASMR']['0'], \
    intro_scale=asmr_start, gwp=9100, prod_max=bigM, land=1100/1800, trl='pilot', block='power_generation', lifetime=30, label='Small modular reactors (SMRs)', \
        citaion='https://www.iaea.org/newscenter/news/what-are-small-modular-reactors-smrs#:~:text=SMRs%20have%20reduced%20fuel%20requirements,to%2030%20years%20without%20refuelling.')
...
network = Network(name= 'Network', source_locations= [HO], sink_locations= [HO], distance_matrix= distance_matrix, transport_matrix= transport_matrix) 
