...
#%%
flex_MILP = flexibility_MIP_reformulation(scenario= reduced_case_sl, penalty = 50000)

#%%

flex_MILP.write('trial.lp', io_options={'symbolic_solver_labels':True})
#%%

def MIP_flex_cases(scenario: Scenario, penalty_list: list):
...
#%%
base_obj = [results.output['objective'] for i in range(10)]
#%%

plt.plot([10000*i for i in range(10)], obj)
plt.plot([10000*i for i in range(10)], base_obj)
